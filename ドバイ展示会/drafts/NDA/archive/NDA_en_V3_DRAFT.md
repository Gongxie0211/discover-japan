...
This Non-Disclosure Agreement (this "Agreement") is entered into as of ____________, 20___ (the "Effective Date"), by and between:

**Disclosing Party:**
CRUX G.K. (クラックス合同会社), a Godo Kaisha organized under the laws of Japan, with its principal place of business at 8-24-12 Horikiri, Katsushika-ku, Tokyo 124-0006, Japan ("Crux" or "Disclosing Party"); and

**Receiving Party:**
________________________________, a [corporation/individual/limited liability company] organized under the laws of ________________________________, with its principal place of business at ________________________________ ("Receiving Party").
...
<!-- V3 Changes: (1) Company name corrected to CRUX G.K. (合同会社); (2) All 4 V3 elements confirmed present (Keystone identity in Art.1, Non-compete Art.5, Injunctive relief Art.11, Condition precedent Art.12) -->
...
(a) use Confidential Information, in whole or in part, to develop, manufacture, test, market, distribute, or sell any product that is the same as or substantially similar to the Product, including any fluoropolymer penetrating coating or anti-fouling treatment, without Crux's prior written consent;
...
15.7 **Language.** This Agreement is executed in the English language, which shall be the controlling version. A Japanese translation may be prepared for reference purposes only; in the event of any inconsistency between the English and Japanese versions, the English version shall prevail.
